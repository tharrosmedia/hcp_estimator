import { db, estimates, estimateMaterials, estimateLabor, users, settings } from '../db';
import { eq, desc } from 'drizzle-orm';
import { calculateEstimate } from './calc.service';
import { Estimate, EstimateMaterial, EstimateLabor, CalcResult } from '../../../shared/types';
